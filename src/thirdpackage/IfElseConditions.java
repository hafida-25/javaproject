...
public class IfElseConditions<year> {
    public static void main(String[] args) {
        int year = 2025;
        System.out.println(year);
        //  if
        //  year is 2021
        //print i will get covid vaccination
        //if not
        ...
        //if year is 2021 or 2020 ,be qurentined
        //else enjoy
...
if (year!=2025) {
    ...
    System.out.println("else block is being executed");
}
int number =10;
...
if (number == 10){
    if(number>14) {
        ...
        System.out.println("num is good");
         ...
         //print"i love java"
        //if year is 2020
        //and year is greater than 2019or 2018
       ...
       // if number is greater than 4 print z
        ...
        //compare 2 string and ignore the cases --> equalIgnoreCase
